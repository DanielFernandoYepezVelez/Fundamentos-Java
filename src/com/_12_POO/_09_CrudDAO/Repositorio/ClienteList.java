...
public class ClienteList implements IAllInterfaces {
    ...
    @Override
    public Cliente porIdCliente(Integer id) {
        Cliente resultadoDB = null;
    ...
    public void eliminar(Integer id) {
        Cliente clienteDB = this.porIdCliente(id);

        this.dataSource.remove(clienteDB);
    }
